...
운영 중 재현하기 어려운 Android 문제의 원인을 끝까지 추적해 해결하고, 그 과정에서 문제를 재현·분석하기 위한 디버깅 도구와 검증 경로를 만들어왔습니다. BLE 의료기기·헬스 데이터·Media3·CameraX/TensorFlow Lite 기능을 제품에 적용하고, 웹뷰 제품에서는 브릿지와 프론트엔드까지 함께 개발했습니다.
